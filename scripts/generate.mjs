...
const servicePath = resolve(pkgRoot, '../../services/settings-service');
...
function normalizeOpenapiServers() {
  ...
  const servers = [
    ...
    '    description: Local settings-service',
    '    variables: {}',
  ];
...
// 1. service contract -> OpenAPI 3.1 (tsp compile specs/settings.tsp -> dist/openapi.yaml)
...
console.log('\nsettings-sdk regenerated from contracts.');
